  ...
  compoundVariants: [
    {
      ...
      class: {
        ...
        item: 'bg-white text-gray-600 hover:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed border border-gray-300 rounded-md transition-colors duration-200 [&[aria-current=page]]:bg-[var(--theme-primary)] [&[aria-current=page]]:text-white cursor-pointer',
